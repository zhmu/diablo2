<?php
	...
	$res = $GLOBALS["DB"]->query("
		SELECT	name,class,level,version
		FROM	charachter
		WHERE	charid=?
	", array($id));
	...
	$GLOBALS["smarty"]->assign("char", $char);
	$GLOBALS["smarty"]->assign("items", $item);
	$GLOBALS["smarty"]->assign("title", "Charachters / " . $char);
	$GLOBALS["smarty"]->display("char.tpl");
 ?>
